...
Training script for BCI Competition IV Dataset 2a with embedding features
"""
...
# Custom imports
from utils import seed_everything, get_embedding_bci2a_ds_cross_subject_dl_prob
from PAttn import PAttnClassifier, LabelSmoothingCrossEntropy
...
with open(metrics_log, 'w') as f:
    f.write("epoch,phase,loss,accuracy,balanced_acc,weighted_f1,macro_f1,cohen_kappa,auc_pr,auroc\n")
...
# ============================================================================
criterion = LabelSmoothingCrossEntropy() if config.use_label_smoothing else nn.CrossEntropyLoss()
...
for epoch in range(EPOCHS):
    # ===== DATA LOADING =====
    train_dl, val_dl, test_dl = get_embedding_bci2a_ds_cross_subject_dl_prob(ds_path, train_val_prob=0.2)
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        # Log batch progress (more frequent for BCI2a due to smaller batches)
        if batch_idx % 5 == 0:
